 ...
 */
export function delta2clusters(newTiles: TileSet, clusters: TileClusters): TileClusters {
    console.log('-----> ENTER')
...
function add2clusters(clusters:  TileClusters, tile: TileNo) {
    if (clusters.allTiles.has(tile)) {
